...
class OrdemPageFinalizada extends StatefulWidget {
  @override
  _OrdemPageFinalizadaState createState() => _OrdemPageFinalizadaState();
}

class _OrdemPageFinalizadaState extends State<OrdemPageFinalizada> {
  ...
  iniciaBloc() {
    ...
    Provider.of<AfBloc>(context, listen: false)
        .fetchStatus(context,Status.ordemFornecedor)
        .then((value) {
      setState(() {
        _isLoadingAf = false;
