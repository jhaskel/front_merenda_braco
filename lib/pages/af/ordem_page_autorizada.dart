...
class OrdemPageAutorizada extends StatefulWidget {
  @override
  _OrdemPageAutorizadaState createState() => _OrdemPageAutorizadaState();
}

class _OrdemPageAutorizadaState extends State<OrdemPageAutorizada> {
  ...
  iniciaBloc() {
    ...
    Provider.of<AfBloc>(context, listen: false)
        .fetchStatus(context,Status.ordemAutorizada)
        .then((value) {
      setState(() {
        _isLoadingAf = false;
                          ...
                          children: [
                            Column(
                              ...
                              children:[
                                Text(nome),
                                p.despesa !=  null
                                    ?Text('Despesa ${p.coddespesa} - ${p.codedespesa}')
                                    :Container()
                        ]
                            ),
                            Text(
