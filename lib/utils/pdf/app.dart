...
class PdffPage extends StatefulWidget {
  @override
  PdffPageState createState() {
    return PdffPageState();
  }
}

class PdffPageState extends State<PdffPage> with SingleTickerProviderStateMixin {
  List<Tab> _myTabs;
